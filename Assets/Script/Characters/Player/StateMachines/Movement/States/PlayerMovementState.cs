...
namespace AILive
{
    public class PlayerMovementState : IState
    {
        ...
        protected void RotateTowardsTargetRotation()
        {
            ...
            float smoothedYAngle = Mathf.SmoothDamp(currentYAngle, stateMachine.ReusableData.CurrentTargetRotation.y, ref stateMachine.ReusableData.DampedTargetRotationCurrentVelocity.y, stateMachine.ReusableData.TimeToReachTargetRotation.y - stateMachine.ReusableData.DampedTargetRotationPassedTime.y);
        ...
        protected void EnableCaeraRecentering(float waitTime=-1f,float recenteringTime = -1f)
        {
            float movementSpeed = GetMovementSpeed();
        ...
        protected void SetCameraRecenteringState(float cameraVerticalAngle, List<PlayerCameraRecenteringData> cameraRecenteringData)
        {
            foreach (PlayerCameraRecenteringData recenteringData in cameraRecenteringData)
            {
                ...
                EnableCaeraRecentering(recenteringData.WaitTime, recenteringData.RecenteringTime);
